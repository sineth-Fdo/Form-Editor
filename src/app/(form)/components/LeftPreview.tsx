        ...
        <div className=' w-[100%] h-10 mb-10'>
            <Tabs defaultValue="content" className="w-[100%]">
                <TabsList className="w-[100%] flex justify-between rounded-sm ">
                    <TabsTrigger value="content" className='text-[13px] rounded-sm'>Content</TabsTrigger>
                    <TabsTrigger value="design"  className='text-[13px] rounded-sm'>Design</TabsTrigger>
                    <TabsTrigger value="share"  className='text-[13px] rounded-sm'>Share</TabsTrigger>
                    <TabsTrigger value="replies"  className='text-[13px] rounded-sm'>Replies</TabsTrigger>
                </TabsList>
